            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="job in jobs" :key="job.id" class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-semibold text-gray-900 whitespace-nowrap dark:text-white">{{ job.title }}</th>
                                <td class="px-4 py-3 whitespace-nowrap">{{ job.description }}</td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center flex-wrap gap-2">
                                        <span v-for="extra in job.extra" :key="extra"
